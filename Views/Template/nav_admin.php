...
<aside class="app-sidebar">
    <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="<?= media(); ?>/images/perfil.png"
            alt="User Image">
        <div>
    ...
    <ul class="app-menu">
        ...
        <?php } ?>
        <?php
        if (!empty($_SESSION['permisos'][4]['r']) || !empty($_SESSION['permisos'][6]['r'])) { ?>
            <li class="treeview">
                <a class="app-menu__item" href="#" data-toggle="treeview">
        ...
        <?php 
        if(!empty($_SESSION['permisos'][MSUSCRIPTORES]['r'])){ ?>
        <li>
