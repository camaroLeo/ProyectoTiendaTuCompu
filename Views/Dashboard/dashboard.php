            ...
            <table class="table table-striped table-sm">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><a href="<?= base_url() ?>/pedidos/orden/<?= $pedido['idpedido'] ?>" target="_blank"><i class="fa fa-eye" arian-hidden="true"></i></a></td>
                </tr>
                <?php }
                } ?>
              </tbody>
...
<script>
  Highcharts.chart('pagosMesAnio', {
      ...
      title: {
          text: 'Ventas por tipo de pago, <?= $data['pagosMes']['mes'].' '.$data['pagosMes']['anio']  ?>',
          align: 'center'
      },
      tooltip: {
