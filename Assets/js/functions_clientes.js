    ...
    request.onreadystatechange = function(){
        ...
        if(request.readyState == 4 && request.status == 200){
            ...
            if(objData.status)
            {
                ...
                document.querySelector("#celIde").value = objData.data.nit;
                document.querySelector("#celNomFiscal").value = objData.data.nombrefiscal; 
                document.querySelector("#celDirFiscal").value = objData.data.direccionfiscal; 
                document.querySelector("#celFechaRegistro").value = objData.data.fechaRegistro; 
