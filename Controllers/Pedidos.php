<?php
	...
	public function orden($idpedido){
		...
		if(empty($_SESSION['permisosMod']['r'])){
            ...
            $data['page_tag'] = "Pedido - Pizza Raul";
            $data['page_title'] = "PEDIDOS <small>Pizza Raul</small>";
	...
	public function transaccion($transaccion){
		...
		$data['page_tag'] = "Detalles de la transacción - Pizza Raul";
		$data['page_title'] = "Detalles de la transacción";
		$data['page_name'] = "detalle_transacción";
		$data['page_functions_js'] = "functions_pedidos.js";
