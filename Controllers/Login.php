...
class Login extends Controllers
{
    ...
    public function login()
    {
        ...
        $data['page_tag'] = "TuCompu";
        $data['page_title'] = "TuCompu";
                ...
                if (empty($arrData)) {
                    ...
                    if ($requestUpdate) {
                        ...
                        if ($sendEmail) {
                            $arrResponse = array(
                                'status' => true,
                                'msg' => 'Se ha enviado un email a tu correo electrónico para recuperar la contraseña. Por favor revisar la bandeja de Spam.'
                            );
                        } else {
                            $arrResponse = array(
                                'status' => false,
